...
class Message:
    ...
    def from_bytes(cls, stream) -> "Message":
        ...
        # print('proto_header: ', proto_header)
        ...
        print('remaining_stream: ', len(remaining_stream) // 16)
...
class MontoneServer(CommandServer):
    ...
    def encrypt(self, msg):
        # print('encrypting msg: ', blockify(msg))
    ...
    def handle_init(self, msg):
        ...
        print('message_metadata: ', self.secret_msg)
        ...
        # print('init - metadata:', message_metadata)
    ...
    def handle_flag(self, msg):
        try:
            ...
            print('self.secret_msg: ', self.secret_msg)
