...
class IGEServer(CommandServer):
    ...
    def encrypt(self, msg):
        ...
        print('plaintext_blocks: ', msg_blocks)
        out_blocks = []
        m_prev = m0
        c_prev = c0
        ...
        # print('ciphertext_blocks: ', out_blocks)
    ...
    def decrypt(self, m0, c0, ctxt):
        ...
        # print('decrypted_blocks: ', out_blocks)
    ...
    def handle_decrypt(self, msg):
        try:
            ...
            print('plaintext decrypted: ', ptxt)
...
if __name__ == "__main__":
    flag = "flag{very_loooooooooooooooooooooooooooooooooooooooooooong_test_flag}"
